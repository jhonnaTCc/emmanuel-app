          ...
          <div className="flex flex-col gap-2">
            {(files ?? []).map((f: any) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3 p-3 rounded-lg border border-slate-100 hover:bg-slate-50 transition-all"
              >
            ...
            {(!files || files.length === 0) && (
              <p className="text-sm text-slate-400">Sin archivos adjuntos todavía.</p>
            )}
          </div>
